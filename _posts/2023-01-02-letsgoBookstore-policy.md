...
3. 개인정보의 처리 및 보유 기간  
    ...
    ② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.  
        ...
        - 보유근거 : finaldestination을 사용하기 위한 필수 정보  <!-- 보유근거 기재 -->
...
* 출처표기  
    ...
    1. 사용된 데이터(서울특별시 버스도착정보조회 서비스, 버스위치정보조회 서비스, 정류소정보조회 서비스)는 https://data.seoul.go.kr/의 License를 따르고 있습니다.    <!-- 사용한 API에 대해 기재 -->
