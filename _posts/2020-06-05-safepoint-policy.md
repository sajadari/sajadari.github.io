...
* 출처표기  
    ...
    1. 사용된 데이터 국토교통부(2D 데이터 API 2.0 레퍼런스 지진대피소 데이터버전 1.0)는 vworld.kr의 License를 따르고 있습니다.    
    2. 사용된 데이터 국토교통부(2D 데이터 API 2.0 레퍼런스 읍면동 데이터버전 1.0)는 vworld.kr의 License를 따르고 있습니다.    
    3. 사용된 데이터 국토교통부(2D 데이터 API 2.0 레퍼런스 시군구 데이터버전 1.0)는 vworld.kr의 License를 따르고 있습니다.    
