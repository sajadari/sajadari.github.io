...
* 출처표기  
    ...
    1. 사용된 데이터 서울특별시(도시생활지도 뉴공중화장실 정보 서비스)는 data.seoul.go.kr의 License를 따르고 있습니다.    
	2. 사용된 데이터 경기도(공중화장실 현황)는 data.gg.go.kr의 License를 따르고 있습니다.   