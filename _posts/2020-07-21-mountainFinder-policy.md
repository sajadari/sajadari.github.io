...
3. 개인정보의 처리 및 보유 기간  
    ...
    ② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.  
        ...
        - 보유근거 : mountainFinder를 사용하기 위한 필수 정보   
...
* 출처표기  
    ...
    1. 사용된 데이터 산 정보 조회(산 정보)와 명산등산로(명산등산로 검색, 명산등산로 조회) 는 Data.go.kr의 License를 따르고 있습니다.   
	2. 사용된 아이콘 이미지는 flaticon에서 다운받은 것으로, flaticon(https://www.flaticon.com/free-icon/mountain_1090663)의 License를 따르고 있습니다.   