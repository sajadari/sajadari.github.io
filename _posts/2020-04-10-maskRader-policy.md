...
* 출처표기  
    ...
    1. 사용된 데이터 건강보험심사평가원 (좌표(위/경도) 기준 공적 마스크 판매정보 제공 서비스)는 Data.go.kr의 License를 따르고 있습니다.   
	2. 사용된 데이터 네이버 (뉴스 검색 서비스)는 네이버의 License를 따르고 있습니다.   