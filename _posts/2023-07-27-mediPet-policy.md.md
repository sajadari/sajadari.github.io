...
3. 개인정보의 처리 및 보유 기간  
    ...
    ② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.  
        ...
        - 보유근거 : 메디펫을 사용하기 위한 필수 정보 <!-- 보유근거 기재 -->
...
* 출처표기  
    ...
    1. 사용된 데이터(서울시 동물약국 인허가 정보, 서울시 약국 운영시간 정보)는 data.seoul.go.kr의 License를 따르고 있습니다.
    2. 사용된 데이터(동물약국 현황, 약국 현황)는 data.gg.go.kr의 License를 따르고 있습니다.
    3. 사용된 아이콘 이미지는 flaticon에서 다운받은 것으로, flaticon(<a href="https://www.flaticon.com/free-icons/veterinary" title="veterinary icons">Veterinary icons created by Freepik - Flaticon</a>)의 License를 따르고 있습니다.