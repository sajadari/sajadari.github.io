...
3. 개인정보의 처리 및 보유 기간  
    ...
    ② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.  
        ...
        - 보유근거 : finaldestination을 사용하기 위한 필수 정보, 롤하자를 사용하기 위한 필수 정보, maskinfo를 사용하기 위한 필수 정보ㅋ  <!-- 보유근거 기재 -->
...
* 출처표기  
    ...
    1. 사용된 데이터 서울특별시(경매장 정보조회 서비스, 아이템 조회 서비스, 캐릭터 조회 서비스)는 https://developers.neople.co.kr/의 License를 따르고 있습니다.
