...
3. 개인정보의 처리 및 보유 기간  
    ...
    ② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.  
        ...
        - 보유근거 : FindLocation을 사용하기 위한 필수 정보
...
* 출처표기  
    ...
    1. 사용된 데이터 펴늬 (편의점 행사 상품 조회 서비스)는 https://pyony.com/privacy/ License를 따르고 있습니다.
	2. 사용된 데이터 YouTube API (편의점 관련 영상 서비스)는 https://developers.google.com/youtube/terms/api-services-terms-of-service 의 License를 따르고 있습니다.
	3. 사용된 아이콘 이미지는 flaticon에서 다운받은 것으로, flaticon("www.flaticon.com 에서 iconixar으로 만든 아이콘")의 License를 따르고 있습니다.