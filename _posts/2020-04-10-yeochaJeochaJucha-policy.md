...
3. 개인정보의 처리 및 보유 기간  
    ...
    ② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.  
        ...
        - 보유근거 : FindParkingLot 를 사용하기 위한 필수 사용자 위치 정보   
...
* 출처표기  
    ...
    1. 사용된 데이터 서울특별시의 서울 열린 데이터 광장(http://data.seoul.go.kr)와 경기도의 경기데이터드림(https://data.gg.go.kr/)의 License를 따르고 있습니다.     
	2. 사용된 아이콘 이미지는 flaticon에서 다운받은 것으로, flaticon(https://www.flaticon.com/free-icon/parking_2439758?term=parking&page=1&position=86)의 License를 따르고 있습니다.    