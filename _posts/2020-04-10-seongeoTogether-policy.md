...
* 출처표기  
    ...
    1. 사용된 데이터 중앙선거관리위원회 (투표소 정보조 회 서비스, 선거공약 정보 조회 서비스, 후보자 정보 조회 서비스, 당선인 정보 조회 서비스)는 Data.go.kr의 License를 따르고 있습니다.     
	2. 사용된 아이콘 이미지는 flaticon에서 다운받은 것으로, flaticon(https://www.flaticon.com/free-icon/ballot_1939642?term=vote&page=1&position=67)의 License를 따르고 있습니다.    