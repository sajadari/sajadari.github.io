...
* 출처표기  
    ...
    1. 사용된 데이터인 공공 와이파이 정보는 서울 열린 데이터 광장(data.seoul.go.kr)의 License를 따르고 있습니다.
	2. 동으로 검색시 신주소, 구주소 변환된 데이터 정보는 도로명주소(juso.go.kr)의 License를 따르고 있습니다.