...
3. 개인정보의 처리 및 보유 기간  
    ...
    ② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.  
        ...
        - 보유근거 : 전기차 도우미를 사용하기 위한 필수 정보 <!-- 보유근거 기재 -->
...
* 출처표기  
    ...
    1. 사용된 데이터(한국전력공사 전기차 충전소 설치현황 서비스, geocode 서비스)는 bigdata.kepco.co.kr의 License를 따르고 있습니다.    <!-- 사용한 API에 대해 기재 --> 
	2. 사용된 데이터(전기차 보조금 현황 서비스)는 infuser.odcloud.kr의 License를 따르고 있습니다.
	3. 사용된 데이터(위도, 경도 제공 서비스)는 map.vworld.kr의 License를 따르고 있습니다.
